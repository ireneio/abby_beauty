    ...
    <LayoutAdmin>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mx-auto max-w-4xl">
            ...
            <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <Tiptap initialContent={watch('features')} setValue={setValue} name="features" />
                </div>
            </section>
            ...
            <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <Tiptap
                      initialContent={watch('ingredients')}
                      setValue={setValue}
                      name="ingredients"
                    />
                </div>
            ...
            <section className="grid gap-x-8 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                    <Tiptap
                      initialContent={watch('target_users')}
                      setValue={setValue}
                      name="target_users"
                    />
                </div>
