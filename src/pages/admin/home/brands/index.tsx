      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div className="max-sm:w-full sm:flex-1">
          ...
          <div className="mt-4 flex max-w-xl gap-4 flex-wrap">
            ...
            <div>
              <Button onClick={() => router.push('/admin/home/brands/sort')}>調整前台排序</Button>
            </div>
          </div>
        </div>
        <Button onClick={() => router.push('/admin/home/brands/creation')}>
          建立
        </Button>
      </div>
      <ul className="mt-4">
                      ...
                      <TableRow key={row.id}>
                          <TableCell>
                            <img
                              src={row.image}
                              alt=""
                              className="object-contain w-[147px] aspect-[1/1]"
                            />
                          </TableCell>
                          <TableCell>
                            <Dropdown>
                              ...
                              <DropdownMenu anchor="bottom end">
                                  <DropdownItem href={`/admin/home/brands/${row.id}/view`}>查看</DropdownItem>
                                  <DropdownItem href={`/admin/home/brands/${row.id}/edit`}>編輯</DropdownItem>
