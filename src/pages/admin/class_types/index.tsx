...
export default function Page() {
    ...
    const getTableData = async (params: any) => {
      ...
      if (res.code === 0) {
        setTableData(res.data.classTypes)
        setPagination((prev) => {
          return {
            ...prev,
  ...
  return (
    <>
      <Head>
        <title>課程管理/課程系列管理</title>
        <meta name="description" content="課程系列管理" />
      </Head>
      <LayoutAdmin>
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="max-sm:w-full sm:flex-1">
            <Heading>課程管理/課程系列管理</Heading>
            <div className="mt-4 flex max-w-xl gap-4 flex-wrap">
              ...
              <div>
                <Button onClick={() => router.push('/admin/class_types/sort')}>調整前台排序</Button>
              </div>
            </div>
          </div>
