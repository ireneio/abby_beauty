  ...
  return (
    <LayoutAdmin>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button onClick={() => router.push('/admin/pages_private/creation')}>
          建立
        </Button>
      </div>
      <ul className="mt-4">
                          ...
                          <TableCell>
                            <Dropdown>
                              ...
                              <DropdownMenu anchor="bottom end">
                                  ...
                                  <DropdownItem href={`/admin/pages_private/${row.id}/view`}>查看</DropdownItem>
                                  <DropdownItem href={`/admin/pages_private/${row.id}/edit`}>編輯</DropdownItem>
                              </DropdownMenu>
                            </Dropdown>
                          </TableCell>
                      </TableRow>
